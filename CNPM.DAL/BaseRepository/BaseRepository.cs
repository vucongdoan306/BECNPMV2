...
{
    public class BaseRepository<CNPMEntity> :IDisposable,IBaseRepository<CNPMEntity>
    {
        protected readonly string _connectionString = "";
        protected MySqlConnection _connection;
        protected readonly string className = typeof(CNPMEntity).Name;
        ...
        public IEnumerable<CNPMEntity> GetAll()
        {
            ...
            var data = _connection.Query<CNPMEntity>(sql);
            Dispose();
            return data;
        }
        ...
        {  
            ...
            var data = _connection.Query<CNPMEntity>(sql, parameters);
            Dispose();
            return data;
        }
        ...
        public object Filter(string? searchText, int pageSize, int pageNumber)
        {
            ...
            var data = _connection.Query<CNPMEntity>(storeName,param: parameters,commandType: CommandType.StoredProcedure);
